...
C     Open LBLRTM file and read in values of upward radiance
      nlev = 52
      OPEN(11,FILE='OUTPUT_LBLRTM_MLS',FORM='FORMATTED')
      READ(11,*)DUM
      READ(11,*)DUM
      READ(11,*)DUM
      READ(11,*)DUM
...
C     Open LBLRTM file and read in values of upward radiance
      nlev = 52
      OPEN(11,FILE='OUTPUT_ARRTM_MLS',FORM='FORMATTED',status='old')
      READ(11,*)DUM
      READ(11,*)DUM
      READ(11,*)DUM
      do 410 i=1,nlev
 ...
 410    continue 
      ...
      open(11,file='OUTPUT_URAD_BTEMP_MLS')
      write(11,950) 
      j = nlev
      do 500 n=1,nlev
...
C     Open LBLRTM file and read in values of upward radiance
      nlev = 60
      OPEN(11,FILE='OUTPUT_LBLRTM_SAW',FORM='FORMATTED')
      READ(11,*)DUM
      READ(11,*)DUM
      READ(11,*)DUM
      READ(11,*)DUM
...
C     Open LBLRTM file and read in values of upward radiance
      ...
      OPEN(11,FILE='OUTPUT_ARRTM_SAW',FORM='FORMATTED',status='old')
      READ(11,*)DUM
      READ(11,*)DUM
      READ(11,*)DUM
      do 4100 i=1,nlev
 ...
 4100    continue 
      ...
      open(11,file='OUTPUT_URAD_BTEMP_SAW')
      write(11,950) 
      j = nlev
      do 5000 n=1,nlev
            If (PMBL(N) .LT. 1.E-2) THEN
...
C     Open LBLRTM file and read in values of upward radiance
      nlev = 61
      OPEN(11,FILE='OUTPUT_LBLRTM_TRP',FORM='FORMATTED')
      READ(11,*)DUM
      READ(11,*)DUM
      READ(11,*)DUM
      READ(11,*)DUM
...
C     Open LBLRTM file and read in values of upward radiance
      ...
      OPEN(11,FILE='OUTPUT_ARRTM_TRP',FORM='FORMATTED',status='old')
      READ(11,*)DUM
      READ(11,*)DUM
      READ(11,*)DUM
      do 610 i=1,nlev
 ...
 610    continue 
      ...
      open(11,file='OUTPUT_URAD_BTEMP_TRP')
      write(11,950) 
      j = nlev
      do 700 n=1,nlev
            If (PMBL(N) .LT. 1.E-2) THEN
