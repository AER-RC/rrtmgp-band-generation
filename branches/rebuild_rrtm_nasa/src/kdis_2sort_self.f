...
c     generate the k-distributions. 
c
...
C***************************************************
     ...
     & FSCDID(17),YI1
      REAL DVP,Y(2400),Z(2400),scoef(0:3000),scoe(0:300)
...
C  ************ START OF EXECUTABLE STATEMENTS **********
      ...
      is = 9
      open(is,file='self.coef',form='formatted')
      read(is,*) scoe(0)
      scoef(0) = scoe(0)
      do 333 ii = 1, 300
         read(is,*) scoe(ii)
