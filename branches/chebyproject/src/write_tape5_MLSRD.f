...
c----------------------------------------------------------------
      ...
      DATA TBND/294.2/,NANG/3/,NLEV/52/,IQUAD/1/
      DATA ICN/1/
     ...
     &               igas1_u,igas2_u,igas_minor_l,igas_minor_u
      ...
      OPEN (UNIT=12, FILE='template_mlsod',STATUS='NEW')
      WRITE(12,100)
...
c      WRITE(12,107) ' 1 51 7   1.000000  ', 
c     &           'MIDLATITUDE SUMM H1=   0.00 ',
c     &           'H2= 70.00   ', 'ANG=   0.000  LEN= 0 '

      close(12)

      OPEN (13, FILE='TAPE5_MLSRD', STATUS='NEW')
 ...
 60   CONTINUE
      ...
      OPEN (14,FILE='RADINIT',STATUS='NEW')
