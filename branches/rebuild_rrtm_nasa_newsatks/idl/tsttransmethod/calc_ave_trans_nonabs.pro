  ...
  for il=0,nlay-1 do begin
    for ia=0,na-1 do begin
      if (transmean(il,ig,0,ia) gt 1.e-4) then begin
        transdiffone_sf1 = [transdiffone_sf1,(transone(il,ig,0,ia)-transzero(il,ig,0,ia))]
        transdiffone_sf2 = [transdiffone_sf2,(transone(il,ig,1,ia)-transzero(il,ig,1,ia))]
        transdiffone_sf3 = [transdiffone_sf3,(transone(il,ig,2,ia)-transzero(il,ig,2,ia))]
        transdifftwo_sf1 = [transdifftwo_sf1,(transtwo(il,ig,0,ia)-transzero(il,ig,0,ia))]
        transdifftwo_sf2 = [transdifftwo_sf2,(transtwo(il,ig,1,ia)-transzero(il,ig,1,ia))]
        transdifftwo_sf3 = [transdifftwo_sf3,(transtwo(il,ig,2,ia)-transzero(il,ig,2,ia))]   
      endif
    endfor
