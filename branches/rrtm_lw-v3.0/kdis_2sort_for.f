...
C***************************************************
     ...
     & FSCDID(17),YI1
      REAL DVP,Y(2400),Z(2400),fcoef(0:4000),fcoe(0:400)
c      REAL DVP,Y(2400),Z(2400),fcoef(0:3000),fcoe(0:3000)
...
C  ************ START OF EXECUTABLE STATEMENTS **********
      ...
      is = 9
      open(is,file='for.coef',form='formatted')
      read(is,*) fcoe(0)
      fcoef(0) = fcoe(0)
      do 333 ii = 1, 400
         read(is,*)fcoe(ii)
