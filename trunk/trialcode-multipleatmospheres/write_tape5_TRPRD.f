...
c----------------------------------------------------------------
      ...
      DATA TBND/300.0/,NANG/3/,NLEV/61/,IQUAD/1/
      DATA ICN/1/
     ...
     &               igas1_u,igas2_u,igas_minor_l,igas_minor_u
      ...
      OPEN (UNIT=12, FILE='template_trpod',STATUS='NEW')
      WRITE(12,100)
...
c      write(12,107)' 1 60 7    1.000000 ',
c     &' ADJUSTED H2O P  H1=  100.00H2=    0.00 ANG= 180.000 LEN= 0'
      close(12)

      OPEN (13, FILE='TAPE5_TRPRD')
 ...
 100  FORMAT('TAPE5 FOR TRP')
 101  FORMAT(A40,A40)
 102  FORMAT(2(A40))
 103  FORMAT('$   TROPICAL ATMOSPHERE ADJUSTED TO RIDGEWAYS GLA MODEL ')
