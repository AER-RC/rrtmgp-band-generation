...
C ***    Process output for this atmosphere.
         OPEN (IWR,FILE='OUTPUT_RRTM_RADIANCE',FORM='FORMATTED')
...
c 9958 FORMAT(1X,I3,5X,F5.0,9X,F8.4,6X,F8.4,6X,F9.4,10X,F9.5)
 ...
 9900 FORMAT(1X,'LEVEL    PRESSURE   UPWARD RAD    DOWNWARD RAD     NET
     &FLUX       HEATING RATE')
...
C     Read in atmospheric profile.
 ...
 1000 CONTINUE
      ...
      READ (IRD,9011) IATM, IXSECT, NUMANGS, IOUT, ICLD, UPANG
...
C     Test for mixing ratio input.
 ...
 9010 FORMAT (A1)
 9011 FORMAT (49X,I1,19X,I1,13X,I2,2X,I3,4X,I1,F10.6)
