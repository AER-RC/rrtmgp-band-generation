...
c     is tailored for the LOWER atmosphere and handles
...
C  **************** BEGIN LOOP OVER PANELS FOR A GIVEN LAYER ****************  C
...
c     be implemented in the case for 2 major gases.
              ...
              ELSE 
                 COLUMFAC = WK(IGAS1_L) + 
     &                (W_L_MLS(IGAS1_L,LEVEL)/W_L_MLS(IGAS2_L,LEVEL))
     &                *WK(IGAS2_L)
                 COLUMFAC = 1.E20/COLUMFAC
              ENDIF
...
C  ********** NUMERICAL RECIPES F77 (QUICKSORT/CHAPTER 8) **********
