...
c            CALL TAUGB9
c         ELSEIF (IBAND .EQ. 10) THEN
c            CALL TAUGB10
c         ELSEIF (IBAND .EQ. 11) THEN
c            CALL TAUGB11
c         ELSEIF (IBAND .EQ. 12) THEN
c            CALL TAUGB12
c         ELSEIF (IBAND .EQ. 13) THEN
c            CALL TAUGB13
c         ELSEIF (IBAND .EQ. 14) THEN
c            CALL TAUGB14
c         ELSEIF (IBAND .EQ. 15) THEN
c            CALL TAUGB15
c         ELSE
c            CALL TAUGB16
         ENDIF
